...
class InstructorChat2 extends StatefulWidget {
  const InstructorChat2({Key? key}) : super(key: key);

  @override
  _InstructorChat2State createState() => _InstructorChat2State();
}

class _InstructorChat2State extends State<InstructorChat2> {
  bool haveins = false;
