...
class FriendChat2 extends StatefulWidget {
  const FriendChat2({Key? key}) : super(key: key);

  @override
  _FriendChat2State createState() => _FriendChat2State();
}

class _FriendChat2State extends State<FriendChat2> {
  @override
